...
export default function CreateGuildForm({
    ...
    return (
        <div className="flex flex-col gap-3 p-8 m-4 rounded-md bg-discordGrey-700 z-[100] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 md:min-w-[40em] md:max-w-[40%] w-5/6">
